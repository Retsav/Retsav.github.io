...
const Bitstudios = () => {
    return (
        <motion.div
            ...
            className={"w-full"}
        >
            <h3 className={"flex gap-1 font-medium text-[24px] font-titleFont"}>Game Tester <span className={"text-textGreen tracking-wide"}>@11 bit studios</span></h3>
